...
class CameraInterface {
  ...
  Future<void> setFrontFlashMode(bool enable) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.CameraInterface.setFrontFlashMode', const StandardMessageCodec(),
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(enable) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
